...
[B1, B2, B3, B4, LED_B, FH_B] = Calc_B_PCB(...
    ...
    FIG_N, 1);
PCB_B = [B1, B2, B3, B4];
Arr_LED = [Arr_LED; LED_B];
FxHls   = [FxHls; FH_B];

ShiftX = 0; ShiftY = D / 90 * Al_Th;
[D1, D2, D3, D4, LED_D, FH_D] = Calc_D_PCB(...
    ShiftX, ShiftY, ...
    BaseX, BaseY,...
    PH_1, PH_2, L, H, Z, Z_D, Z_D_S, LED,...
    A, B, G, D, ...
...
ShiftX = -(90 - A) / 90 * Al_Th; ShiftY = 0;
[E1, E2, E3, E4, E5, E6, LED_E, FH_E] = Calc_E_PCB(...
    ShiftX, ShiftY, ...
    BaseX, BaseY,...
    PH_1, PH_2, L, H, Z, Z_D, Z_D_S, LED,...
    A, B, G, D, ...
...
BOTTOM_GAP = 0;
ShiftX = (90 - G) / 90 * Al_Th; ShiftY = 0;
[C1, C2, C3, C4, C5, C6, LED_C, FH_C] = Calc_C_PCB(...
    ShiftX, ShiftY, ...
    BaseX, BaseY,...
    PH_1, PH_2, L, H, Z, Z_D, Z_D_S, LED,...
    A, B, G, D, ...
...
[Ce1, Ce2, Ce3, Ce4] = Calc_Central_PCB(...
    ShiftX, ShiftY, ...
    BaseX, BaseY,...
    PH_1, PH_2, L, H, Z, Z_D, Z_D_S, LED,...
    A, B, G, D, ...
    ...
    PCB_W, ...
    100, 1);
PCB_Ce = [Ce1, Ce2, Ce3, Ce4];


[Ce1_T, Ce2_T, Ce3_T, Ce4_T] = Calc_Central_PCB_turned(...
    0, 0, ...
    BaseX, BaseY,...
    PH_1, PH_2, L, H, Z, Z_D, Z_D_S, LED,...
    A, B, G, D, ...
