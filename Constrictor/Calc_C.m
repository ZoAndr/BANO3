function [C1, C2, C3, C4, C5, C6] = Calc_C(...
    ShiftX, ShiftY, ...
    BaseX, BaseY,...
...
figure(FIG_N)
for c = 1: N_C - 1
    line([C_DOTS(c, 1) C_DOTS(c + 1, 1)], [C_DOTS(c, 2) C_DOTS(c + 1, 2)]);
end
line([C_DOTS(N_C, 1) C_DOTS(1, 1)], [C_DOTS(N_C, 2) C_DOTS(1, 2)]);

text( (C_DOTS(1, 1) + C_DOTS(4, 1))/2, (C_DOTS(1, 2) + C_DOTS(4, 2))/2, 'C');
end