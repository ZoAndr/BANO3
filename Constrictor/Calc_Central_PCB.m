function [B1, B2, B3, B4] = Calc_Central_PCB(...
    ShiftX, ShiftY, ...
    BaseX, BaseY,...
...
figure(FIG_N)
for c = 1: N_B - 1
    line([B_DOTS(c, 1) B_DOTS(c + 1, 1)], [B_DOTS(c, 2) B_DOTS(c + 1, 2)], 'color', 'GREEN');
end
line([B_DOTS(N_B, 1) B_DOTS(1, 1)], [B_DOTS(N_B, 2) B_DOTS(1, 2)], 'color', 'GREEN');
